...
Пример использования метода (можно было все свернуть в одну строчку, но для наглядности все
элементы вынесены в отдельные переменные):
...
public class JavaCore_7_1_9 {
    ...
    public static void main(String[] args) {
        ...
        safeStringLength.apply("Hi");//2
        safeStringLength.apply(null);//0
    ...
    public static <T, U> Function<T, U> ternaryOperator(Predicate<? super T> condition, Function<? super T, ? extends U> ifTrue, Function<? super T, ? extends U> ifFalse) {
        return  Function -> condition.test(Function) ? ifTrue.apply(Function) : ifFalse.apply(Function);
    }
